            ...
            if (obj.btn.yes || obj.btn.del || obj.btn.no) {//创建操作按钮（确定、取消）
                ...
                if (obj.btn.yes) {//创建确定
                    ...
                    switch (obj.btn.yes_style) {//按钮样式
                        case "blue" :
                            $(yes).addClass("g-btn-init");
                            break;
                        case "white" :
                            $(yes).addClass("g-btn-white");
                            break;
                        case "orange" :
                            $(yes).addClass("g-btn-orange");
                            break;
                    }
                ...
                if (obj.btn.del) {//
                    ...
                    switch (obj.btn.del_style) {//按钮样式
                        case "blue" :
                            $(del).addClass("g-btn-init");
                            break;
                        case "white" :
                            $(del).addClass("g-btn-white");
                            break;
                        case "orange" :
                            $(del).addClass("g-btn-orange");
                            break;
                    }
                ...
                if (obj.btn.no) {//创建取消
                    ...
                    switch (obj.btn.no_style) {//按钮样式
                        case "blue" :
                            $(no).addClass("g-btn-init");
                            break;
                        case "white" :
                            $(no).addClass("g-btn-white");
                            break;
                        case "orange" :
                            $(no).addClass("g-btn-orange");
                            break;
                    }
